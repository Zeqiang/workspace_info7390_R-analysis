...
dataset <- read.csv("/Users/lzq/Documents/course material/INFO 7390 - Das/Assignments/week06/wdbc.data", head = FALSE)
...
# write.csv(dataset,"/Users/lzq/Documents/course material/INFO 7390 - Das/Assignments/week06/wdbc.csv",row.names = FALSE)  
